...
<html>
    <head>
        <title>Vanilla - Connection</title>
    ...
    <body>
        ...
        <div class="container-fluid">
          <div class="row no-gutter">
            ...
            <div class="col-md-8 col-lg-6 bg-dark">
              <div class="login d-flex align-items-center py-5 bg-dark">
                <div class="container bg-dark">
                  <div class="row">
                    <div class="col-md-9 col-lg-8 mx-auto bg-dark">
                      <h3 class="login-heading mb-4 text-white">Vanilla Unicorn - Los Santos</h3>
                      <form method="post">
                  ...
                  <label class="custom-control-label text-white-50" for="customCheck1">Se souvenir </label>
                </div>
